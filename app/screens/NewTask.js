    ...
    this.state = {
     ...
     createTask = () => {
       ...
       Alert.alert('Confirmação', 'Deseja realmente criar esta tarefa ?', [
         {
           text: 'Sim',
           onPress: () => new MyStorage().add(this.state).then((newData) => {
         ...
         {
           text: 'Não',
           onPress: () => console.log('Canceling creation new task..'),
         },
       ]);
     }
         ...
         <View style={styles.container}>
           <KeyboardAwareScrollView contentContainerStyle={{ flex: 1 }}>
             <View style={styles.topBar}>
               ...
               <Text style={{ flex: 3, color: '#006bff', ...styles.title }} onPress={() => this.createTask()}>
                    ADD
               </Text>
             </View>
